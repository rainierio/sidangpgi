        ...
        <div class="md-collapse">
          <div class="md-collapse-wrapper">
            ...
            <md-list>
              ...
              <md-list-item>
                <p> 
                  <router-link to="/tentang" exact> 
                    Tentang Sidang Raya PGI
                  </router-link>
                </p>
              </md-list-item>
              ...
              <md-list-item href="https://www.facebook.com/" target="_blank">
                ...
                <md-tooltip md-direction="bottom">Like kami di facebook</md-tooltip>
              </md-list-item>
              <md-list-item href="https://www.instagram.com/CreativeTimOfficial" target="_blank">
                <i class="fab fa-instagram"></i>
                <p class="hidden-lg">Instagram</p>
                <md-tooltip md-direction="bottom">Follow kami di Instagram</md-tooltip>
              </md-list-item>
            </md-list>
          </div>
        </div>
